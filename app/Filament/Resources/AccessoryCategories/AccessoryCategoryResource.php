...
use App\Filament\Resources\AccessoryCategories\Pages\ManageAccessoryCategories;
...
class AccessoryCategoryResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Accessory Categories';
    ...
    {
        return [
            'index' => ManageAccessoryCategories::route('/'),
        ];
    }
}
